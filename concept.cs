        ...
        foreach( System.Data.DataRow row in ds.Tables[0].Rows )//or similar
         {
           ...
           row[4] = row[4].ToString().Replace(",","~");
            ...
            strConcepts.Add( "<a href='javascript:OpenConceptEdit("+row[0].ToString()+");' >"+ row[0].ToString()+"</a>,"+row[1].ToString()+","+row[2].ToString()+","+row[3].ToString()+", <div class=\"thumbnail\"><div class=\"thumbnail-view\"><a class=\"thumbnail-view-hover ui-lightbox\" href=\"./images/"+row[4].ToString()+"\"><img src=\"./images/"+row[4].ToString() +"\" width='100px' height='100px' /></a></div></div> " ); 
