...
<head>
  <title>Class Enrollment - Innovakids</title>
              ...
              <div class="portlet-body">                
                    ...
                    <div class="list-group">  
                        ...
                        <a href="account-parents.php" class="list-group-item">
                            ...
                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Parents
                            <i class="fa fa-chevron-right list-group-chevron"></i>

                        </a> 

                        <a href="account-classview.php" class="list-group-item">

                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;View Class
                            <i class="fa fa-chevron-right list-group-chevron"></i>
...
<!-- Plugin JS -->
<script src="./js/students/table_classenrollment.js"></script>
