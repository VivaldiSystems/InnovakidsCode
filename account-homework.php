...
<head>
  <title>Homework Search - Innovakids</title>
...
?>                             </span>
                        ...
                        <a href="account-classes.php" class="list-group-item">
                            ...
                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Homework Analysis
                            <i class="fa fa-chevron-right list-group-chevron"></i>
          ...
          <div class="col-md-9 col-sm-9">
            ...
            <div class="portlet">
                ...
                <h3 class="portlet-title">
                    ...
                    <a href="account-classadd.php" class="btn btn-secondary">Add Homework</a>&nbsp;&nbsp;
...
<!-- Plugin JS -->
<script src="./js/lessons/table_homework.js"></script> 
