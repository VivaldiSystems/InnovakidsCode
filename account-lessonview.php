...
$tsql = "Select count(*) As ClassCount from Assignment where LessonNo = '".$_COOKIE['lessonno']."'";     
...
?>                             </span>
                        ...
                        <a href="account-homework.php" class="list-group-item">
                  <i class="fa fa-envelope text-primary"></i> &nbsp;&nbsp;Homework
        ...
        <div class="col-md-9 col-sm-7">
           ...
           <div class="col-md-8 col-sm-12">
              ...
              <h4>Lesson View&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                &nbsp;&nbsp;
                <a href="account-classedit.php" class="btn btn-secondary">Edit Lesson</a>
                &nbsp;&nbsp;
               </h4>    

               <label for="class-codetitle"  id="class-codetitle" style="font-size:18px"> <?php
...
$tsql = "Select '('+Convert(Varchar,LessonNo)+') '+Lesson As TitleName from Lesson where LessonNo = '".$_COOKIE['lessonno']."'";     
