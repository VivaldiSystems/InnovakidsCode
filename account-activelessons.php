...
$tsql = "select count(*) from Homework where schoolno =  '".$_COOKIE['schoolno']."' and active = 1";   
...
<!-- Plugin JS -->
<script src="./js/lessons/table_activelessons.js"></script>
