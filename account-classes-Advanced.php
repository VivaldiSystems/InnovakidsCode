          ...
          <div class="col-md-9 col-sm-9">
            ...
            <div class="portlet">
                ...
                <h3 class="portlet-title">
                    ...
                    <a href="account-classes.php" class="btn btn-secondary">Basic View</a>&nbsp;&nbsp;
                ...
                <div class="portlet-body">
                    ...
                    <table class="table table-striped table-bordered" id="table-1">
                        ...
                        <thead>
                            <tr>
                                <th style="width: 75">Class Code</th>
                                <th style="width: 150">Class Description</th>
                                <th style="width: 100">Teacher</th>
                                <th style="width: 75">Room</th>
                                <th style="width: 75">Class #</th>
                                <th style="width: 40">Period</th>
                                <th style="width: 100">Class Type</th>
                                 <th style="width: 100">Subject</th>
                                 <th style="width: 60">Enrolled</th>
                                 <th style="width: 100">Begin</th>
                                 <th style="width: 100">End</th>
                                 <th style="width: 100">Ext Code</th>
                            </tr>
                        </thead>
...
<!-- Plugin JS -->
<script src="./js/classes/table_classes_advanced.js"></script>
