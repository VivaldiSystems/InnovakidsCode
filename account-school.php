              ...
              <div class="portlet-body">                
                    ...
                    <div class="list-group">  
                        ...
                        <a href="account-lesson-manager.php" class="list-group-item">
                            ...
                            <i class="fa fa-cog text-primary"></i> &nbsp;&nbsp;Teachers
                            <i class="fa fa-chevron-right list-group-chevron"></i>
                        ...
                        <a href="account-class-events.php" class="list-group-item">
          ...
          <div class="col-md-9 col-sm-9">
            ...
            <div class="portlet">
                ...
                <h3 class="portlet-title">
                    ...
                    <a href="account-classadd.php" class="btn btn-secondary">Add New School</a>&nbsp;&nbsp;
