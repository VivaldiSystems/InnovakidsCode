...
public class ClassUtility
{
     ...
     public string[][] GetClassesAdvanced(string SchoolNo,string argFilter)
    {
           ...
           return GetClassAdvancedDataString("Select Code,Class,Teacher,Room,ClassNo,Period,ClassType,Subject,CurrentEnrollment,BegTime,EndTime from class where schoolno  = '" + SchoolNo + "' and "+argFilter+" Order By Code",1,1000);
        ...
        foreach( System.Data.DataRow row in ds.Tables[0].Rows )//or similar
         {
          ...
          row[6] = row[6].ToString().Replace(",","~");
           ...
           // row[20] = row[20].ToString().Replace(",","~");
           ...
           // row[24] = row[24].ToString().Replace(",","~");
            //row[25] = row[25].ToString().Replace(",","~");
           // row[26] = row[26].ToString().Replace(",","~");
           // row[27] = row[27].ToString().Replace(",","~");
            //row[28] = row[28].ToString().Replace(",","~");
           // row[29] = row[29].ToString().Replace(",","~");
           // row[30] = row[30].ToString().Replace(",","~");
          
           
           // row[31] = row[31].ToString().Replace(",","~");
           // row[32] = row[32].ToString().Replace(",","~");
           // row[33] = row[33].ToString().Replace(",","~");
           // row[34] = row[34].ToString().Replace(",","~");
           // row[35] = row[35].ToString().Replace(",","~");
           // row[36] = row[36].ToString().Replace(",","~");

          
          strClasses.Add( row[0].ToString()+","+row[1].ToString()+","+row[2].ToString()+","+row[3].ToString()+","+row[4].ToString()+","+row[5].ToString() +","+row[6].ToString()+","+row[7].ToString()+","+row[8].ToString()+","+row[9].ToString() );  
        ...
        foreach( System.Data.DataRow row in ds.Tables[0].Rows )//or similar
         {
            ...
            strClasses.Add("<a href='javascript:OpenClassEdit("+row[4].ToString()+");' >"+ row[0].ToString()+"</a>,"+row[1].ToString()+","+row[2].ToString()+","+row[3].ToString()+","+row[5].ToString()+","+row[6].ToString()+","+row[7].ToString()+","+row[8].ToString()+","+row[9].ToString()+","+row[10].ToString() );
